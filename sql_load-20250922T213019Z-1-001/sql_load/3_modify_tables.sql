...
COPY company_dim
FROM 'C:\Users\jthai\Documents\SQL_Project_DATA_JOBS\csv_files-20250922T213014Z-1-001\company_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_dim
FROM 'C:\Users\jthai\Documents\SQL_Project_DATA_JOBS\csv_files-20250922T213014Z-1-001\skills_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY job_postings_fact
FROM 'C:\Users\jthai\Documents\SQL_Project_DATA_JOBS\csv_files-20250922T213014Z-1-001\job_postings_fact.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_job_dim
FROM 'C:\Users\jthai\Documents\SQL_Project_DATA_JOBS\csv_files-20250922T213014Z-1-001\skills_job_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
